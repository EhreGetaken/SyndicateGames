...
public class APIManager {
    ...
    private String securityKey = "vM2Dqi4RPtMhQPuBnA2RA2OVIDGYTg6iUfRO";
    private boolean debug = false;

    public APIManager(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public APIManager setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public APIManager setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public APIManager debug() {
        debug = true;
        return this;
    }
    ...
    public ValidationType isValid() {
        ...
        try {
            ...
            if (response.startsWith("<")) {
                log(1, "The API-Server returned an invalid response!");
